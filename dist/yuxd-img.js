...
(0, _tinyImg2.default)(function (img, handledImgPath) {
  (0, _qn2.default)(_path2.default.join(process.env.QNPATH || '', img), handledImgPath, _ywxx.ACCESS_KEY, _ywxx.SECRET_KEY, _ywxx.bucket);
});

},{"../ywxx.json":4,"./qn.js":1,"./tinyImg.js":2,"path":undefined}],4:[function(require,module,exports){
module.exports={
  "bucket": "yunwang",
